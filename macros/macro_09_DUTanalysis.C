void macro_09_DUTanalysis() {
    ...
    h1->SetTitle("ATLASpix_0: Hitmap of all clusters");
    h1->Draw("colz");

    c1->cd(2);
    gPad->SetRightMargin(0.13);
    h2->GetZaxis()->SetTitle("# entries");
    h2->SetTitle("ATLASpix_0: Hitmap of associated clusters");
    h2->Draw("colz");
    ...
    c1->SaveAs("../figures/09_DUTanalysis.pdf");
}
